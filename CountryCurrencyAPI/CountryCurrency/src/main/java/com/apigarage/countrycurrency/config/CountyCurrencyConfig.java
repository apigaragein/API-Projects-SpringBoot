package com.apigarage.countrycurrency.config;
...
@Configuration
@EnableSwagger2
public class CountyCurrencyConfig extends WebMvcConfigurerAdapter {

    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Currency API")
                .description("Currency API reference for developers")
